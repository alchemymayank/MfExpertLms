...
import net.rmitsolutions.mfexpert.lms.Constants.ACCESS_TOKEN
import net.rmitsolutions.mfexpert.lms.Constants.getAppAuthWebViewData
...
class LoginActivity : BaseActivity(), IAppAuthWebViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val data = getAppAuthWebViewData()
